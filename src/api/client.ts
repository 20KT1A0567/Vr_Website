...
export const catalogApi = {
  ...
  getContentPage: (slug: string) => unwrap<CmsPage>(api.get(`/public/cms-pages/${slug}`)),
  getNavigation: () => unwrap<NavigationConfig>(api.get("/public/navigation")),
  ...
  getSeoSetting: (params: { targetType: string; targetId?: number; targetSlug?: string }) =>
    unwrap<SeoSetting | null>(api.get("/seo/settings", { params })),
